...
Namespace Examples.Shapes.SineCircles
    Public Class DoubleCosCirclePathType
        Inherits SineCircleType
        Public Sub New(parent As SineCircle)
            MyBase.New(parent)
        End Sub
        Public Overrides Function getPath(Degree As Integer) As Point
            Dim tempradius = Me.parent.Radius + Me.parent.frequency * Math.Cos(Me.parent.depth * Degree + Degree) * Math.Sin(Me.parent.depth * Degree - Degree)
