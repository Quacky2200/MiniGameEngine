...
Public Class SimilarColor
    ...
    ''' <remarks></remarks>
    Public Sub New(similarColor As Color, Depth As Double)
        ...
        Dim HSLColorMinimum As Color = RGBHSL.ModifyHue(similarColor, minHue / 360)
        Dim HSLColorMaximum As Color = RGBHSL.ModifyHue(similarColor, maxHue / 360)
