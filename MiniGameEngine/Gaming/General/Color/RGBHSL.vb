    ...
    Public Class RGBHSL
        ...
        Public Class HSL
            ...
            Public Property H() As Double
                ...
                Set(value As Double)
                    _h = value
                    _h = CDbl(If(_h > 1, 1, If(_h < 0, 0, _h)))
                End Set
            End Property
            ...
            Public Property S() As Double
                ...
                Set(value As Double)
                    _s = value
                    _s = CDbl(If(_s > 1, 1, If(_s < 0, 0, _s)))
                End Set
            End Property
            ...
            Public Property L() As Double
                ...
                Set(value As Double)
                    _l = value
                    _l = CDbl(If(_l > 1, 1, If(_l < 0, 0, _l)))
                End Set
            End Property
        End Class 'HSL
        ...
        Public Shared Function HSL_to_RGB(hsl As HSL) As Drawing.Color
            Dim r As Double = 0
            Dim g As Double = 0
            Dim b As Double = 0
            ...
            Else
                If hsl.S = 0 Then
                    ...
                    b = hsl.L
                Else
                    temp2 = CDbl(If(hsl.L <= 0.5, hsl.L * (1.0 + hsl.S), hsl.L + hsl.S - hsl.L * hsl.S))
            ...
            Return Drawing.Color.FromArgb(CInt(255 * r), CInt(255 * g), CInt(255 * b))
