Namespace Transitions
    Public Class DoubleTransition
        ...
        End Sub
        Public Overrides Function ConvertFromRaw(rawValues() As Double) As Double
            Return rawValues(0)
        End Function

        Public Overrides Function ConvertToRaw(obj As Double) As Double()
            Return {obj}
        End Function
    End Class
End Namespace